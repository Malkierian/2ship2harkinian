...
static const std::unordered_map<int32_t, const char*> audioBackendsMap = {
    { AUDIO_WASAPI, "Windows Audio Session API" },
    { AUDIO_SDL, "SDL" },
};
...
static std::unordered_map<int32_t, const char*> windowBackendsMap = {
    { FAST3D_DXGI_DX11, "DirectX" },
    { FAST3D_SDL_OPENGL, "OpenGL" },
    { FAST3D_SDL_METAL, "Metal" },
};
...
cvarObject enhancementList[] = {
    ...
    { MENU_ITEM_AUDIO_BACKEND,
      "Audio API",
      "gSettings.AudioBackend",
      "Sets the audio API used by the game.Requires a relaunch to take effect.",
      COMBOBOX,
      { 0, 0, 0, audioBackendsMap },
      ([]() {
          Ship::Context::GetInstance()->GetAudio()->SetAudioBackend(
              Ship::AudioBackend(CVarGetInteger("gSettings.AudioBackend", 0)));
      }) },
    // Graphics Settings
    { MENU_ITEM_TOGGLE_FULLSCREEN,
      "Toggle Fullscreen",
    ...
    { MENU_ITEM_RENDERER_API,
      ...
      "gSettings.WindowBackend",
      "Sets the renderer API used by the game. Requires a relaunch to take effect.",
      COMBOBOX,
      { 0, 0, 0, windowBackendsMap },
      ([]() {
          Ship::Context::GetInstance()->GetConfig()->SetInt(
              "Window.Backend.Id", static_cast<int32_t>(CVarGetInteger("gSettings.WindowBackend", 0)));
          Ship::Context::GetInstance()->GetConfig()->SetString(
              "Window.Backend.Name", windowBackendsMap[CVarGetInteger("gSettings.WindowBackend", 0)]);
    ...
    { MENU_ITEM_HUD_EDITOR,
      "Popout Hud Editor",
      "gWindows.HudEditor",
      "Enables the Hud Editor window, allowing you to edit your hud",
      WINDOW_BUTTON,
      {},
      nullptr },
};
