...
std::vector<ImVec4> menuTheme = {
    ...
    ImVec4(0.24f, 0.31f, 0.71f, 1.0f),
    ImVec4(0.5f, 0.0f, 0.0f, 1.0f),
    ImVec4(0.3f, 0.0f, 0.0f, 1.0f),
    ImVec4(0.0f, 0.7f, 0.0f, 1.0f),
    ImVec4(0.0f, 0.5f, 0.0f, 1.0f),
    ImVec4(0.0f, 0.3f, 0.0f, 1.0f),
...
cvarObject enhancementList[] = {
    // Menu Theme
    { MENU_ITEM_MENU_THEME, "Menu Theme", "gSettings.MenuTheme",
        "Changes the Theme of the Menu Widgets.",
        COMBOBOX, { 0, 0, 0, menuThemeOptions }, nullptr },
    // General Settings
    { MENU_ITEM_MENUBAR_CONTROLLER_NAV, "Menubar Controller Navigation", CVAR_IMGUI_CONTROLLER_NAV,
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CURSOR_VISIBILITY, "Cursor Always Visible", "gSettings.CursorVisibility",
        "Makes the cursor always visible, even in full screen.",
      CHECKBOX,
      {},
      ([]() { Ship::Context::GetInstance()->GetWindow()->SetForceCursorVisibility(CVarGetInteger("gSettings.CursorVisibility", 0)); }) },
    { MENU_ITEM_HOTKEY_TEXT, "Hide Menu Hotkey Text", "gSettings.DisableMenuShortcutNotify",
        "Prevents showing the text telling you the shortcut to open the menu\n"
        "when the menu isn't open.",
        CHECKBOX, { }, nullptr },
    // Audio Settings
    { MENU_ITEM_MASTER_VOLUME, "Master Volume: %.2f%%", "gSettings.Audio.MasterVolume",
        "Adjust overall sound volume.",
        SLIDER_FLOAT, { 0, 100, 100 }, nullptr },
    { MENU_ITEM_MAIN_MUSIC_VOLUME, "Main Music Volume: %.2f%%", "gSettings.Audio.MainMusicVolume",
    ...
    { MENU_ITEM_SUB_MUSIC_VOLUME , "Sub Music Volume: %.2f%%", "gSettings.Audio.SubMusicVolume",
    ...
    { MENU_ITEM_SOUND_EFFECT_VOLUME, "Sound Effects Volume: %.2f%%", "gSettings.Audio.SoundEffectsVolume",
    ...
    { MENU_ITEM_FANFARE_VOLUME, "Fanfare Volume: %.2f%%", "gSettings.Audio.FanfareVolume",
    ...
    { MENU_ITEM_AMBIENT_VOLUME, "Ambience Volume: %.2f%%", "gSettings.Audio.AmbienceVolume",
        "Adjust the Ambient Sound volume.",
        SLIDER_FLOAT, { 0, 100, 100 }, 
      ([]() {
        AudioSeq_SetPortVolumeScale(SEQ_PLAYER_AMBIENCE, CVarGetFloat("gSettings.Audio.AmbienceVolume", 1.0f));
      }) },
    //{ MENU_ITEM_AUDIO_BACKEND }, Unused placeholder
    // Graphics Settings
    { MENU_ITEM_TOGGLE_FULLSCREEN, "Toggle Fullscreen", "gSettings.Fullscreen",
        "Toggles Fullscreen On/Off.",
      CHECKBOX,
      { },
      ([]() { Ship::Context::GetInstance()->GetWindow()->ToggleFullscreen(); }) },
    { MENU_ITEM_INTERNAL_RESOLUTION, "Internal Resolution: %f%%", CVAR_INTERNAL_RESOLUTION,
    ...
    { MENU_ITEM_MSAA, "Anti-aliasing (MSAA): %d",
        CVAR_MSAA_VALUE, "Activates MSAA (multi-sample anti-aliasing) from 2x up to 8x, to smooth the edges of rendered "
                         "geometry.\n"
                         "Higher sample count will result in smoother edges on models, but may reduce performance.",
      SLIDER_INT,
      { 1, 8, 1 },
      ([]() { Ship::Context::GetInstance()->GetWindow()->SetMsaaLevel(CVarGetInteger(CVAR_MSAA_VALUE, 1)); }) },
    { MENU_ITEM_FRAME_RATE, "Crrent FPS: %d", "gInterpolationFPS", 
        "Uses Matrix Interpolation to create extra frames, resulting in smoother graphics. This is "
        "purely visual and does not impact game logic, execution of glitches etc.\n\n A higher target "
        "FPS than your monitor's refresh rate will waste resources, and might give a worse result.",
        SLIDER_INT, { 20, 360, 20 }, nullptr },
    { MENU_ITEM_MATCH_REFRESH_RATE, "Match Refresh Rate", "",
    ...
    { MENU_ITEM_JITTER_FIX, "Jitter fix : >= % d FPS", "gExtraLatencyThreshold",
        ...
        SLIDER_INT, { 0, 360, 80 }, nullptr },
    //{ MENU_ITEM_RENDERER_API }, Unused placeholder
    { MENU_ITEM_ENABLE_VSYNC, "Enable Vsync", CVAR_VSYNC_ENABLED,
        "Enables Vsync.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_ENABLE_WINDOWED_FULLSCREEN, "Windowed Fullscreen", CVAR_SDL_WINDOWED_FULLSCREEN,
        "Enables Windowed Fullscreen Mode.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_ENABLE_MULTI_VIEWPORT, "Allow multi-windows", CVAR_ENABLE_MULTI_VIEWPORTS,
        "Allows multiple windows to be opened at once. Requires a reload to take effect.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_TEXTURE_FILTER, "Texture Filter (Needs reload)", CVAR_TEXTURE_FILTER,
        "Sets the applied Texture Filtering.",
        COMBOBOX, { 0, 0, 0, textureFilteringMap }, nullptr },
    // Input Editor
    { MENU_ITEM_INPUT_EDITOR, "Popout Input Editor", "gWindows.BenInputEditor",
        "Enables the separate Input Editor window.",
        BUTTON, { }, nullptr },
    // Camera Snap Fix
    { MENU_ITEM_FIX_TARGET_CAMERA_SNAP, "Fix Targetting Camera Snap", "gEnhancements.Camera.FixTargettingCameraSnap",
        "Fixes the camera snap that occurs when you are moving and press the targetting button.",
        CHECKBOX, { }, nullptr },
    // Free Look Settings
    { MENU_ITEM_ENABLE_FREE_LOOK, "Free Look", "gEnhancements.Camera.FreeLook.Enable",
        ...
        CHECKBOX, { }, ([]() { RegisterCameraFreeLook(); }) },
    { MENU_ITEM_FREE_LOOK_CAMERA_DISTANCE, "Camera Distance: %d", "gEnhancements.Camera.FreeLook.MaxCameraDistance",
        "Maximum Camera Distance for Free Look.",
        SLIDER_INT, { 100, 900, 185 }, nullptr },
    { MENU_ITEM_FREE_LOOK_TRANSITION_SPEED, "Camera Transition Speed: %d", "gEnhancements.Camera.FreeLook.TransitionSpeed",
        "Can someone help me?",
        SLIDER_INT, { 1, 900, 25 }, nullptr },
    { MENU_ITEM_FREE_LOOK_MAX_PITCH, "Max Camera Height Angle: %.0f\xC2\xB0", "gEnhancements.Camera.FreeLook.MaxPitch",
        "Maximum Height of the Camera.",
        SLIDER_FLOAT, { -8900, 8900, 7200 }, nullptr },
    { MENU_ITEM_FREE_LOOK_MIN_PITCH, "Min Camera Height Angle: %.0f\xC2\xB0", "gEnhancements.Camera.FreeLook.MinPitch",
        "Minimum Height of the Camera.",
        SLIDER_FLOAT, { -8900, 8900, -4900 }, nullptr },
    // Camera Enhancements
    { MENU_ITEM_ENABLE_DEBUG_CAMERA, "Debug Camera", "gEnhancements.Camera.DebugCam.Enable",
        "Enables free camera control.",
        CHECKBOX, { }, ([]() { RegisterDebugCam(); }) },
    { MENU_ITEM_INVERT_CAMERA_X_AXIS, "Invert Camera X Axis", "gEnhancements.Camera.RightStick.InvertXAxis",
        "Inverts the Camera X Axis",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_INVERT_CAMERA_Y_AXIS, "Invert Camera Y Axis", "gEnhancements.Camera.RightStick.InvertYAxis",
        "Inverts the Camera Y Axis",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_THIRD_PERSON_CAMERA_X_SENSITIVITY, "Third-Person Horizontal Sensitivity: %.0f",
        "gEnhancements.Camera.RightStick.CameraSensitivity.X",
        "Adjust the Sensitivity of the x axis when in Third Person.",
        SLIDER_FLOAT, { 1, 500, 100 }, nullptr },
    { MENU_ITEM_THIRD_PERSON_CAMERA_Y_SENSITIVITY, "Third-Person Vertical Sensitivity: %.0f",
        "gEnhancements.Camera.RightStick.CameraSensitivity.Y",
        "Adjust the Sensitivity of the x axis when in Third Person.",
        SLIDER_FLOAT, { 1, 500, 100 }, nullptr },
    { MENU_ITEM_ENABLE_CAMERA_ROLL, "Enable Roll (6\xC2\xB0 of Freedom)", "gEnhancements.Camera.DebugCam.6DOF",
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CAMERA_SPEED, "Camera Speed: %.0f", "gEnhancements.Camera.DebugCam.CameraSpeed",
        "Adjusts the speed of the Camera.",
        SLIDER_FLOAT, { 10, 300, 50 }, nullptr },
    // Cheats
    { MENU_ITEM_CHEATS_INFINITE_HEALTH, "Infinite Health", "gCheats.InfiniteHealth",
        "Always have full Hearts.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CHEATS_INFINITE_MAGIC, "Infinite Magic", "gCheats.InfiniteMagic",
        "Always have full Magic.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CHEATS_INFINITE_RUPEES, "Infinite Rupees", "gCheats.InfiniteRupees",
        "Always have a full Wallet.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CHEATS_INFINITE_CONSUMABLES, "Infinite Consumables", "gCheats.InfiniteConsumables",
        "Always have max Consumables, you must have collected the consumables first.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CHEATS_LONG_FLOWER_GLIDE, "Longer Deku Flower Glide", "gCheats.LongerFlowerGlide",
        "Allows Deku Link to glide longer, no longer dropping after a certain distance.",
        CHECKBOX, { }, ([]() { RegisterLongerFlowerGlide(); }) },
    { MENU_ITEM_CHEATS_NO_CLIP, "No Clip", "gCheats.NoClip",
        "Allows Link to phase through collision.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CHEATS_INFINITE_RAZOR_SWORD, "Unbreakable Razor Sword", "gCheats.UnbreakableRazorSword",
        "Allows to Razor Sword to be used indefinitely without dulling its blade.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CHEATS_UNRESTRICTED_ITEMS, "Unrestricted Items", "gCheats.UnrestrictedItems",
        "Allows all Forms to use all Items.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_CHEATS_MOON_JUMP_ON_L, "Moon Jump on L", "gCheats.MoonJumpOnL",
        "Holding L makes you float into the air.",
        CHECKBOX, { }, ([]() { RegisterMoonJumpOnL(); }) },
	// Gameplay Enhancements
    { MENU_ITEM_FAST_FLOWER_LAUNCH, "Fast Deku Flower Launch", "gEnhancements.Player.FastFlowerLaunch",
		"Speeds up the time it takes to be able to get maximum height from launching out of a deku flower",
		CHECKBOX, { }, ([]() { RegisterFastFlowerLaunch(); }) },
    { MENU_ITEM_INSTANT_PUTAWAY, "Instant Putaway", "gEnhancements.Player.InstantPutaway",
		"Allows Link to instantly puts away held item without waiting.",
		CHECKBOX, { }, nullptr },
    { MENU_ITEM_CLIMB_SPEED, "Climb speed", "gEnhancements.PlayerMovement.ClimbSpeed",
		"Increases the speed at which Link climbs vines and ladders.",
		SLIDER_INT, { 1, 5, 1 }, nullptr },
    { MENU_ITEM_DPAD_EQUIPS, "Dpad Equips", "gEnhancements.Dpad.DpadEquips",
		"Allows you to equip items to your d-pad",
		CHECKBOX, {  }, nullptr },
    { MENU_ITEM_ALWAYS_WIN_DOGGY_RACE, "Always Win Doggy Race", "gEnhancements.Minigames.AlwaysWinDoggyRace",
		"Makes the Doggy Race easier to win.",
		COMBOBOX, { 0, 0, 0, alwaysWinDoggyraceOptions }, nullptr },
    // Game Modes
    { MENU_ITEM_PLAY_AS_KAFEI, "Play as Kafei", "gModes.PlayAsKafei",
        "Requires scene reload to take effect.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_TIME_MOVES_WHEN_YOU_MOVE, "Time Moves when you Move", "gModes.TimeMovesWhenYouMove",
        "Time only moves when Link is not standing still.",
        CHECKBOX, { }, ([]() { RegisterTimeMovesWhenYouMove(); }) },
    // Saving Enhancements
    { MENU_ITEM_PERSIST_OWL_SAVES, "Persistent Owl Saves", "gEnhancements.Saving.PersistentOwlSaves",
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_PAUSE_MENU_SAVE, "Pause Menu Save", "gEnhancements.Saving.PauseSave",
        ...
        "in South Clock Town.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_AUTOSAVE, "Autosave", "gEnhancements.Saving.Autosave",
        ...
        CHECKBOX, { }, ([]() { RegisterAutosave(); }) },
    { MENU_ITEM_AUTOSAVE_INTERVAL, "Autosave Interval: %d minutes", "gEnhancements.Saving.AutosaveInterval",
        "Sets the interval between Autosaves.",
        SLIDER_INT, { 1, 60, 5 }, nullptr },
    { MENU_ITEM_DISABLE_BOTTLE_RESET, "Do not reset Bottle content", "gEnhancements.Cycle.DoNotResetBottleContent",
        "Playing the Song Of Time will not reset the bottles' content.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_DISABLE_CONSUMABLE_RESET, "Do not reset Consumables", "gEnhancements.Cycle.DoNotResetConsumables",
        "Playing the Song Of Time will not reset the consumables.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_DISABLE_RAZOR_SWORD_RESET, "Do not reset Razor Sword", "gEnhancements.Cycle.DoNotResetRazorSword",
        "Playing the Song Of Time will not reset the Sword back to Kokiri Sword.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_DISABLE_RUPEE_RESET, "Do not reset Rupees", "gEnhancements.Cycle.DoNotResetRupees",
        "Playing the Song Of Time will not reset the your rupees.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_DISABLE_SAVE_DELAY, "Disable Save Delay", "gEnhancements.Saving.DisableSaveDelay",
    ...
    { MENU_ITEM_CLOCK_OPTIONS, "Clock Type", "gEnhancements.Graphics.ClockType",
        "Swaps between Graphical and Text only Clock types.",
        COMBOBOX, { 0, 0, 0, clockTypeOptions }, nullptr },
    { MENU_ITEM_MILITARY_CLOCK, "24 Hours Clock", "gEnhancements.Graphics.24HoursClock",
        "Changes from a 12 Hour to a 24 Hour Clock",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_MOTION_BLUR_MODE, "Motion Blur Mode", "gEnhancements.Graphics.MotionBlur.Mode",
        "Selects the Mode for Motion Blur.",
        COMBOBOX, { 0, 0, 0, motionBlurOptions }, nullptr },
    { MENU_ITEM_MOTION_BLUE_INTERPOLATE, "Interpolate", "gEnhancements.Graphics.MotionBlur.Interpolate",
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_MOTION_BLUR_ENABLE, "On/Off", "gEnhancements.Graphics.MotionBlur.Toggle",
        "Enables Motion Blur.",
      CHECKBOX,
      {},
      ([]() {
    ...
    { MENU_ITEM_MOTION_BLUR_STRENGTH, "Strength", "gEnhancements.Graphics.MotionBlur.Strength",
        "Motion Blur strength.",
        SLIDER_INT, { 0, 255, 180 }, nullptr },
    { MENU_ITEM_AUTHENTIC_LOGO, "Authentic Logo", "gEnhancements.Graphics.AuthenticLogo", 
        "Hide the game version and build details and display the authentic "
        "model and texture on the boot logo start screen",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_BOW_RETICLE, "Bow Reticle", "gEnhancements.Graphics.BowReticle",
        "Gives the bow a reticle when you draw an arrow.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_DISABLE_BLACK_BARS, "Disable Black Bar Letterboxes", "gEnhancements.Graphics.DisableBlackBars",
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_GEOMETRY_DISTANCE_CHECK, "Disable Scene Geometry Distance Check", "gEnhancements.Graphics.DisableSceneGeometryDistanceCheck",
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_ACTOR_DRAW_DISTANCE, "Increase Actor Draw Distance: %dx", "gEnhancements.Graphics.IncreaseActorDrawDistance",
    ...
    { MENU_ITEM_ACTOR_UPDATE_DISTANCE, "Increase Actor Update Distance: %dx", "gEnhancements.Graphics.IncreaseActorUpdateDistance",
      ...
      ([]() { CVarSetInteger("gEnhancements.Graphics.IncreaseActorDrawDistance",
                         MAX(CVarGetInteger("gEnhancements.Graphics.IncreaseActorDrawDistance", 1),
                             CVarGetInteger("gEnhancements.Graphics.IncreaseActorUpdateDistance", 1))); }) },
    // Mask Enhancements
    { MENU_ITEM_BLAST_MASK_KEG_FORCE, "Blast Mask has Powder Keg Force", "gEnhancements.Masks.BlastMaskKeg",
        "Blast Mask can also destroy objects only the Powder Keg can.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_FAST_TRANSFORMATION, "Fast Transformation", "gEnhancements.Masks.FastTransformation",
        "Removes the delay when using transormation masks.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_FIERCE_DEITY_ANYWHERE, "Fierce Deity's Mask Anywhere", "gEnhancements.Masks.FierceDeitysAnywhere",
        "Allow using Fierce Deity's mask outside of boss rooms.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_NO_BLAST_MASK_COOLDOWN, "No Blast Mask Cooldown", "gEnhancements.Masks.NoBlastMaskCooldown",
        "Eliminates the Cooldown between Blast Mask usage.",
        CHECKBOX, { }, nullptr },
    // Song Enhancements
    { MENU_ITEM_ENABLE_SUNS_SONG, "Enable Sun's Song", "gEnhancements.Songs.EnableSunsSong",
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_DPAD_OCARINA, "Dpad Ocarina", "gEnhancements.Playback.DpadOcarina",
        "Enables using the Dpad for Ocarina playback.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_PREVENT_DROPPED_OCARINA_INPUTS, "Prevent Dropped Ocarina Inputs", "gEnhancements.Playback.NoDropOcarinaInput",
        "Prevent dropping inputs when playing the ocarina quickly.",
        CHECKBOX, { }, nullptr },
    // Cutscene Skips
    { MENU_ITEM_HIDE_TITLE_CARDS, "Hide Title Cards", "gEnhancements.Cutscenes.HideTitleCards",
        "Hides Title Cards when entering areas.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_SKIP_ENTRANCE_CUTSCENES, "Skip Entrance Cutscenes", "gEnhancements.Cutscenes.SkipEntranceCutscenes",
        "Skip cutscenes that occur when first entering a new area.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_SKIP_TO_FILE_SELECT, "Skip to File Select", "gEnhancements.Cutscenes.SkipToFileSelect",
        "Skip the opening title sequence and go straight to the file select menu after boot.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_SKIP_INTRO_SEQUENCE, "Skip Intro Sequence", "gEnhancements.Cutscenes.SkipIntroSequence",
        "When starting a game you will be taken straight to South Clock Town as Deku Link.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_SKIP_STORY_CUTSCENES, "Skip Story Cutscenes", "gEnhancements.Cutscenes.SkipStoryCutscenes",
        "Disclaimer: This doesn't do much yet, we will be progressively adding more skips over time.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_SKIP_MISC_INTERACTIONS, "Skip Misc Interactions", "gEnhancements.Cutscenes.SkipMiscInteractions",
        "Disclaimer: This doesn't do much yet, we will be progressively adding more skips over time.",
        CHECKBOX, { }, nullptr },
    // Dialogue Enhancements
    { MENU_ITEM_FAST_BANK_SELECTION, "Fast Bank Selection", "gEnhancements.Dialogue.FastBankSelection",
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_FAST_TEXT, "Fast Text", "gEnhancements.Dialogue.FastText",
        "Speeds up text rendering, and enables holding of B progress to next message.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_FAST_MAGIC_ARROW_ANIM, "Fast Magic Arrow Equip Animation", "gEnhancements.Equipment.MagicArrowEquipSpeed",
        "Removes the animation for equipping Magic Arrows.",
        CHECKBOX, { }, nullptr },
    // Fixes
    { MENU_ITEM_FIX_AMMO_COUNT_COLOR, "Fix Ammo Count Color", "gFixes.FixAmmoCountEnvColor",
        ...
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_FIX_HESS_WEIRDSHOT, "Fix Hess and Weirdshot Crash", "gEnhancements.Fixes.HessCrash",
        "Fixes a crash that can occur when performing a HESS or Weirdshot.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_FIX_TEXT_CONTROL_CHAR, "Fix Text Control Characters", "gEnhancements.Fixes.ControlCharacters",
        "Fixes certain control characters not functioning properly "
        "depending on their position within the text.",
        CHECKBOX, { }, nullptr },
    // Restorations
    { MENU_ITEM_RESTORE_DISTANCE_FLIPS_HOPS, "Constant Distance Backflips and Sidehops", "gEnhancements.Restorations.ConstantFlipsHops",
        "Backflips and Sidehops travel a constant distance as they did in OoT.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_RESTORE_POWER_CROUCH_STAB, "Power Crouch Stab", "gEnhancements.Restorations.PowerCrouchStab",
        "Crouch stabs will use the power of Link's previous melee attack, as is in MM JP 1.0 and OoT.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_RESTORE_SIDEROLLS, "Side Rolls", "gEnhancements.Restorations.SideRoll",
        "Restores side rolling from OoT.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_RESTORE_TATL_ISG, "Tatl ISG", "gEnhancements.Restorations.TatlISG",
        "Restores Navi ISG from OoT, but now with Tatl.",
        CHECKBOX, { }, nullptr },
    // HUD Editor
    // { MENU_ITEM_HUD_EDITOR }, Unused placeholder
    { MENU_ITEM_MODERN_MENU_POPOUT, "Popout Menu", "gSettings.Menu.Popout",
        "Changes the menu display from overlay to windowed.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_OPEN_APP_FILES, "Open App Files Folder", "",
    ...
    { MENU_ITEM_DEBUG_MODE_ENABLE, "Debug Mode", "gDeveloperTools.DebugEnabled",
    ...
    { MENU_ITEM_DEBUG_BETTER_MAP_SELECT, "Better Map Select", "gDeveloperTools.BetterMapSelect.Enabled",
        "Overrides the original map select with a translated, more user-friendly version.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_DEBUG_SAVE_FILE_MODE, "Debug Save File Mode", "gDeveloperTools.DebugSaveFileMode",
        ...
        COMBOBOX, { 0, 0, 0, debugSaveOptions }, ([]() { RegisterDebugSaveCreate(); }) },
    { MENU_ITEM_PREVENT_ACTOR_UPDATE, "Prevent Actor Update", "gDeveloperTools.PreventActorUpdate",
        "Prevents Actors from updating.",
        CHECKBOX, { }, ([]() { RegisterPreventActorUpdateHooks(); }) },
    { MENU_ITEM_PREVENT_ACTOR_DRAW, "Prevent Actor Draw", "gDeveloperTools.PreventActorDraw",
        "Prevents Actors from drawing.",
        CHECKBOX, { }, ([]() { RegisterPreventActorDrawHooks(); }) },
    { MENU_ITEM_PREVENT_ACTOR_INIT, "Prevent Actor Init", "gDeveloperTools.PreventActorInit",
        "Prevents Actors from initializing.",
        CHECKBOX, { }, ([]() { RegisterPreventActorInitHooks(); }) },
    { MENU_ITEM_DISABLE_OBJECT_DEPENDECY, "Disable Object Dependency", "gDeveloperTools.DisableObjectDependency",
        "Disables dependencies when loading objects.",
        CHECKBOX, { }, nullptr },
    { MENU_ITEM_DEBUG_LOG_LEVEL, "Log Level", "gDeveloperTools.LogLevel",
    ...
    { MENU_ITEM_FRAME_ADVANCE_ENABLE, "Frame Advance", "gDeveloperTools.FrameAdvance",
    ...
    { MENU_ITEM_FRAME_ADVANCE_SINGLE, "Advance 1", "",
        "Advance 1 frame.",
        BUTTON, { }, ([]() { CVarSetInteger("gDeveloperTools.FrameAdvanceTick", 1); }) },
    { MENU_ITEM_FRAME_ADVANCE_HOLD, "Advance (Hold)", "",
...
void SearchMenuGetItem(uint32_t index) {
	...
	switch (enhancementList[index].widgetType) {
        ...
        case SLIDER_FLOAT:
            ...
            if (UIWidgets::CVarSliderFloat(enhancementList[index].cVarText, enhancementList[index].cVarName,
